    ...
    decks: [
      {
        ...
        terms: [
          ...
          },
          {
            term: "Консоль",
            definition:
              "Текстовое окно или среда для ввода текста и просмотра вывода программы. Первые C# приложения часто делают именно в таком формате."
          },
          {
            term: "Командная строка",
            definition:
              "Способ управления компьютером через текстовые команды. Так можно создать, собрать и запустить C# проект командами dotnet."
          }
        ]
      },
      {
      ...
      },
      {
        ...
        terms: [
          ...
          },
          {
            term: "Свойство",
            definition:
              "Именованный доступ к данным объекта или класса. Снаружи выглядит как поле, но внутри может содержать проверку или вычисление."
          },
          {
            term: "Метод",
            definition:
              "Действие или операция, описанная внутри класса. Его вызывают, когда нужно заставить объект или тип что-то сделать."
          },
          {
            term: "Инкапсуляция",
            definition:
